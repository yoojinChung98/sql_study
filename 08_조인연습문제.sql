...
각각 INNER , LEFT OUTER, RIGHT OUTER, FULL OUTER 조인 하세요. (달라지는 행의 개수 확인 --주석으로 작성)
*/
SELECT *
FROM employees e
...
-- INNER JOIN + kimberly (부서가 null 인 데이터_)가 추가됨

SELECT *
FROM employees e RIGHT JOIN departments d
ON e.department_id = d.department_id; --122
--INNER JOIN + 사원이(null)인 d의 데이터 16행 추가됨 
...
ON e.department_id = d.department_id
WHERE Lower(CONCAT(e.first_name,e.last_name)) = 'stevenking';
